...
export const polulateDB = () => {
	db.tx(t => {
        ...
        "VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", ["shaolinmkz", "Chukwuemeka", "Nwabuzor", "Obiora", "nwabuzor.obiora@gmail.com", "07067443245", hash, true]),
			t.none("INSERT INTO incidents(title, comment, type, location, images, videos, status, createdBy) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", ["Bad Roads In ABC town", "It all started when the earth rumbled...", "red-flag", "12.233334, 2.323123", "http://jamaica-star.com/sites/default/files/styles/460px/public/media/article_images/2017/11/21/BadroadsA20171121RM.jpg?itok=K72fUdU5", "https://youtu.be/bPYbg-nrWzg", "draft", 1]),
			t.none("INSERT INTO incidents(title, comment, type, location, images, videos, status, createdBy) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", ["Bad Roads In ABC town", "It all started when the earth rumbled...", "intervention", "12.233334, 2.323123", "http://jamaica-star.com/sites/default/files/styles/460px/public/media/article_images/2017/11/21/BadroadsA20171121RM.jpg?itok=K72fUdU5", "https://youtu.be/bPYbg-nrWzg", "draft", 2]),
			t.none("INSERT INTO incidents(title, comment, type, location, images, videos, status, createdBy) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", ["Bad Roads In ABC town", "It all started when the earth rumbled...", "red-flag", "12.233334, 2.323123", "http://jamaica-star.com/sites/default/files/styles/460px/public/media/article_images/2017/11/21/BadroadsA20171121RM.jpg?itok=K72fUdU5", "https://youtu.be/bPYbg-nrWzg", "draft", 2]),
		]);
	});
};
